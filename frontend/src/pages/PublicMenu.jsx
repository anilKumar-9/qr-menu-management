...
import { MapPin, UtensilsCrossed, Phone, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#FAFAFA] font-sans">
      ...
      <div className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 text-white overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 py-14 text-center">
          <motion.div
            ...
            className="w-24 h-24 mx-auto bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-4xl font-black shadow-xl border border-white/20"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center items-center gap-4 mt-4 text-orange-100 text-sm"
          >
            {restaurant?.address && (
                  ...
                  <div className="space-y-4">
                    {menuItems.map((item) => (
                      <motion.div
                        key={item._id}
                        whileHover={{ y: -2 }}
                        className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all flex justify-between gap-4"
                      >
                        ...
                        <div className="w-20 h-20 bg-gradient-to-br from-orange-50 to-red-50 rounded-xl flex items-center justify-center shrink-0">
      ...
      <footer className="mt-20 bg-white border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-6 py-12 text-center">
          <div className="w-14 h-14 bg-gradient-to-br from-orange-500 to-red-600 text-white rounded-2xl flex items-center justify-center text-2xl font-black mx-auto shadow-lg shadow-orange-500/20">
            {restaurant?.name?.charAt(0)}
          </div>
